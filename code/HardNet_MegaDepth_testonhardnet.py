...
def main(train_loader, test_loaders, training_dataset, validation_dataset,model, logger, file_logger):
    ...
    for epoch in range(start, end):
        ...
        #_, test_loaders2 = create_loaders(load_random_triplets=triplet_flag)
...
if __name__ == '__main__':
    ...
    _, test_loaders = create_loaders(load_random_triplets = triplet_flag)
...
#        pairs_per_scene=25,
    ...
    test_loader_megadepth = DataLoader(
        validation_dataset,
        batch_size=args.batch_size,
        num_workers=4
    )
    ...
    writefile.close()
"""
    main(train_loader, test_loaders,training_dataset, validation_dataset,model, logger, file_logger)
